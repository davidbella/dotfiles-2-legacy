...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  orgmode = {
    ...
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/orgmode",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["vim-elixir"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/vim-elixir",
